 ...
 */
public class frmProductBrower extends javax.swing.JFrame {
   static frmCreateBill code;

    /** Creates new form frmItemBrower */
    public frmProductBrower() {
        initComponents();
        refresh();
    }
    ...
    private void txtItemNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtItemNameKeyReleased
        ...
        if(str.equals("")) {
            ...
            sql="select * from Products where ProductName like '%"+str+"%'";
        }
        try {
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
        ...
        else
        {
           ...
           code.txtProductID.setText(tblItems.getValueAt(row,0).toString());
           this.dispose();
        }
...
private void refresh()
{
    ...
    */
    ...
    public void run() {
    new frmProductBrower().setVisible(true);
    }
    });
    }*/
